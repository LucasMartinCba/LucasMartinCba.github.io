...
let CelularComponent = class CelularComponent {
    constructor(activatedRoute, celularesService, router) {
        this.activatedRoute = activatedRoute;
        this.celularesService = celularesService;
        this.router = router;
        this.celulares = [];
        this.activatedRoute.params.subscribe(params => {
            this.celular = this.celularesService.getCelular(params['id']);
        });
...
CelularComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _servicios_celulares_service__WEBPACK_IMPORTED_MODULE_3__["CelularesService"] },
...
let CelularesComponent = class CelularesComponent {
    // tslint:disable-next-line:variable-name
    constructor(celularesService, router) {
        this.celularesService = celularesService;
        this.router = router;
        this.celularesApple = [];
...
CelularesComponent.ctorParameters = () => [
...
let CelularesService = class CelularesService {
    constructor() {
        // @ts-ignore
        // @ts-ignore
        this.celulares = [
    ...
    getCelularesApple() {
        let celularesApple = [];
        for (let celular of this.celulares) {
    ...
    getCelularesMotorola() {
        let celularesMotorola = [];
        for (let celular of this.celulares) {
            let marca = celular.marca;
            if (marca === 'Motorola') {
    ...
    buscarHeroes(termino) {
        ...
        for (let heroe of this.celulares) {
